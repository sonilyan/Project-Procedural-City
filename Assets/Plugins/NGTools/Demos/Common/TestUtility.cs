	...
	public static class TestUtility
	{
		...
		public static bool	IsMaximized(UnityEditor.EditorWindow window)
		{
			if (TestUtility.windowLayout == null)
			{
				...
				if (TestUtility.windowLayout == null)
					Debug.LogError("Type \"" + TestUtility.WindowLayoutType + "\" was not found in assembly. It may happens in newer version of Unity. Please contact NG Tools.");
			}
			if (TestUtility.windowLayout != null && TestUtility.isMaximized == null)
			{
				...
				if (TestUtility.isMaximized == null)
					Debug.LogError("Method \"" + TestUtility.IsMaximizedMethod + "\" was not found in type \"" + TestUtility.WindowLayoutType + "\". It may happens in newer version of Unity. Please contact NG Tools.");
			}
		...
		public static void	UnmaximizeWindow(UnityEditor.EditorWindow window)
		{
			...
			if (TestUtility.windowLayout != null && TestUtility.unmaximize == null)
			{
				...
				if (TestUtility.unmaximize == null)
					Debug.LogError("Method \"" + TestUtility.UnmaximizeMethod + "\" was not found in type \"" + TestUtility.WindowLayoutType + "\". It may happens in newer version of Unity. Please contact NG Tools.");
			}
		...
		public static void	MaximizeWindow(UnityEditor.EditorWindow window)
		{
			...
			if (TestUtility.windowLayout != null && TestUtility.maximize == null)
			{
				...
				if (TestUtility.maximize == null)
					Debug.LogError("Method \"" + TestUtility.MaximizeMethod + "\" was not found in type \"" + TestUtility.WindowLayoutType + "\". It may happens in newer version of Unity. Please contact NG Tools.");
			}
